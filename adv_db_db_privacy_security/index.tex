...
% \addcontentsline{toc}{chapter}{\refname} %make bibliography as reference chapter 
    ...
    \bibitem{a_comprve_rev_of_sec_measr_in_db_sys_assess_auth_accss_ctrl_bynd}  \hyperref[sec:a_comprve_rev_of_sec_measr_in_db_sys_assess_auth_accss_ctrl_bynd_1]{Habeeb O., and Maryam A., ``A Comprehensive Review of Security Measures in Database Systems: Assessing Authentication, Access Control, and Beyond"} 
