...
\addcontentsline{toc}{chapter}{\refname} %make bibliography as reference chapter 
    \bibitem{db_security_an_overview_and_analysis_of_current_trend}  \hyperref[sec:db_security_an_overview_and_analysis_of_current_trend_1]{Database Security: An Overview and Analysis of Current Trend} 
